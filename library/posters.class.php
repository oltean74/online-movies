 ...
 if (!defined('BASE_PATH')) {
  ...
  class Posters
  {
      ...
      public function return_images()
      {
          ...
          $this->poster =
 '<img class="img-front" src='.$url1.' alt="Filme online" width="163" height="236" />
<img class="img-mid" src='.$url2.' alt="Filme online" width="163" height="236" />
<img class="img-back" src='.$url3.' alt="Filme online" width="163" height="236" />';
