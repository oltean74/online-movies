...
function __autoload($className)
{
    if (file_exists(BASE_PATH.'library/'.strtolower($className).'.class.php')) {
        ...
        echo' An error occured.Please check real url of '.strtolower($className).'.class.php';
    }
}

function load_movie($lang, $name)
{
    if (file_exists(BASE_PATH.'application/movies/'.strtolower($lang).'/content/'.strtolower($lang).'.'.strtolower($name).'.php')) {
        require_once BASE_PATH.'application/movies/'.strtolower($lang).'/content/'.strtolower($lang).'.'.strtolower($name).'.php';
    } else {
        echo' An error occured.Please check real url of '.strtolower($lang).'.'.strtolower($name).'.php';
    }
}
